                    ...
                    if (pawn != null)
                    {
                        ...
                        if (map != null)
                        {
                            ...
                            if (cell != IntVec3.Invalid)
                            {
                                ...
                                ChoiceLetter let = LetterMaker.MakeLetter("VREA_ReturnsLabel".Translate(pawn.NameFullColored), "VREA_Returns".Translate(pawn.NameFullColored), LetterDefOf.PositiveEvent, pawn);
